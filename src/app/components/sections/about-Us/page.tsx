...
export default function AboutPage() {
  ...
  return (
    <main className="bg-black text-[#f5f0e8] overflow-x-hidden">
      {/* Hero Section */}
      <section className="min-h-screen lg:min-h-[100vh] grid lg:grid-cols-2 items-end px-6 md:px-8 lg:px-[60px] pb-16 lg:pb-[90px] pt-32 lg:pt-0 relative overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="absolute font-['Bebas_Neue',sans-serif] text-[28vw] text-[rgba(152,102,203,0.04)] right-[-3vw] top-1/2 -translate-y-1/2 leading-none pointer-events-none select-none tracking-[-0.02em]">
          17
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#9866cb]">Our Story</span>
          </div>
        ...
        <div className="relative z-10 hidden lg:flex flex-col items-end gap-0 pb-1">
          {stats.map((stat, idx) => (
            <div key={idx} className="text-right py-6 border-t border-[rgba(152,102,203,0.2)] w-[220px] last:border-b">
              <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#9866cb] leading-none mb-1">{stat.num}</div>
              <div className="text-[0.62rem] tracking-[0.15em] uppercase text-[#888]">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="bg-black relative overflow-hidden transition-all duration-400 hover:-translate-y-1 group">
            <div className="w-full aspect-[3/4] bg-[#0d0d0d] relative overflow-hidden transition-transform duration-600 group-hover:scale-105">
              <div className="w-full h-full flex flex-col items-center justify-center relative">
                <div className="absolute inset-0 bg-[linear-gradient(rgba(152,102,203,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(152,102,203,0.04)_1px,transparent_1px)] bg-[length:28px_28px]" />
                <div className="absolute w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(152,102,203,0.08)_0%,transparent_70%)] rounded-full" />
                <div className="w-[130px] h-[130px] rounded-full border border-[rgba(152,102,203,0.25)] flex items-center justify-center relative z-10 bg-[rgba(152,102,203,0.06)]">
                  <div className="font-['Cormorant_Garamond',serif] text-[3.8rem] font-light text-[#9866cb] leading-none">G</div>
                </div>
              </div>
            ...
            <div className="p-7 lg:p-[28px]">
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                ...
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Fashion Law</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Commercial Litigation</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Brand Strategy</span>
              </div>
          ...
          <div className="bg-black relative overflow-hidden transition-all duration-400 hover:-translate-y-1 group">
            <div className="w-full aspect-[3/4] bg-[#0d0d0d] relative overflow-hidden transition-transform duration-600 group-hover:scale-105">
              <div className="w-full h-full flex flex-col items-center justify-center relative">
                <div className="absolute inset-0 bg-[linear-gradient(rgba(152,102,203,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(152,102,203,0.04)_1px,transparent_1px)] bg-[length:28px_28px]" />
                <div className="absolute w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(152,102,203,0.08)_0%,transparent_70%)] rounded-full" />
                <div className="w-[110px] h-[110px] rounded-full border border-[rgba(152,102,203,0.25)] flex items-center justify-center relative z-10 bg-[rgba(152,102,203,0.06)]">
                  <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#9866cb] leading-none">A</div>
                </div>
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(10,10,10,0.85)] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
            <div className="p-7">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-4 h-px bg-[#9866cb]" />
                <span className="text-[0.6rem] tracking-[0.18em] uppercase text-[#9866cb]">Associate — Influencer & Creator Law</span>
              </div>
              <div className="font-['Cormorant_Garamond',serif] text-2xl font-normal mb-1 text-[#f5f0e8]">Adv. Aanya Mehta</div>
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Influencer Law</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">ASCI Compliance</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Creator Contracts</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Media Law</span>
              </div>
              <div className="inline-flex items-center gap-2 border border-[rgba(152,102,203,0.25)] px-3.5 py-1.5 text-[0.62rem] tracking-[0.1em] uppercase text-[#9866cb]">
              ...
              <div className="flex gap-2.5 mt-4">
                <a href="#" className="w-8 h-8 border border-[rgba(245,240,232,0.06)] flex items-center justify-center text-[0.7rem] text-[#777] no-underline transition-all hover:border-[#9866cb] hover:text-[#9866cb]">in</a>
                <a href="mailto:aanya@buzzlaw.in" className="w-8 h-8 border border-[rgba(245,240,232,0.06)] flex items-center justify-center text-[0.7rem] text-[#777] no-underline transition-all hover:border-[#9866cb] hover:text-[#9866cb]">✉</a>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black relative overflow-hidden transition-all duration-400 hover:-translate-y-1 group">
            <div className="w-full aspect-[3/4] bg-[#0d0d0d] relative overflow-hidden transition-transform duration-600 group-hover:scale-105">
              <div className="w-full h-full flex flex-col items-center justify-center relative">
                ...
                <div className="absolute w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(152,102,203,0.08)_0%,transparent_70%)] rounded-full" />
                <div className="w-[110px] h-[110px] rounded-full border border-[rgba(152,102,203,0.25)] flex items-center justify-center relative z-10 bg-[rgba(152,102,203,0.06)]">
                  <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#9866cb] leading-none">R</div>
                </div>
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-[rgba(10,10,10,0.85)] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
            <div className="p-7">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-4 h-px bg-[#9866cb]" />
                <span className="text-[0.6rem] tracking-[0.18em] uppercase text-[#9866cb]">Associate — Brand Protection & Fashion Law</span>
              </div>
              <div className="font-['Cormorant_Garamond',serif] text-2xl font-normal mb-1 text-[#f5f0e8]">Adv. Rohan Batra</div>
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Trademark Prosecution</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Fashion Law</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Anti-Counterfeiting</span>
                <span className="text-[0.58rem] tracking-[0.1em] uppercase border border-[rgba(152,102,203,0.25)] px-2.5 py-1 text-[rgba(245,240,232,0.4)]">Startup Law</span>
              </div>
              <div className="inline-flex items-center gap-2 border border-[rgba(152,102,203,0.25)] px-3.5 py-1.5 text-[0.62rem] tracking-[0.1em] uppercase text-[#9866cb]">
              ...
              <div className="flex gap-2.5 mt-4">
                <a href="#" className="w-8 h-8 border border-[rgba(245,240,232,0.06)] flex items-center justify-center text-[0.7rem] text-[#777] no-underline transition-all hover:border-[#9866cb] hover:text-[#9866cb]">in</a>
                <a href="mailto:rohan@buzzlaw.in" className="w-8 h-8 border border-[rgba(245,240,232,0.06)] flex items-center justify-center text-[0.7rem] text-[#777] no-underline transition-all hover:border-[#9866cb] hover:text-[#9866cb]">✉</a>
              </div>
            </div>
          </div>
        </div>
