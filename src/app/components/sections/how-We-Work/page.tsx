...
export default function HowWeWorkPage() {
  ...
  return (
    <main className="bg-black text-[#f5f0e8] overflow-x-hidden">
      {/* Hero Section */}
      <section className="min-h-screen grid lg:grid-cols-2 items-end px-6 md:px-8 lg:px-16 pb-16 lg:pb-[90px] pt-32 lg:pt-0 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_55%_70%_at_75%_35%,rgba(201,168,76,0.07)_0%,transparent_65%),radial-gradient(ellipse_40%_50%_at_15%_75%,rgba(184,92,56,0.05)_0%,transparent_55%)]" />
          <div className="absolute inset-0 bg-[linear-gradient(rgba(201,168,76,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(201,168,76,0.035)_1px,transparent_1px)] bg-[length:72px_72px]" />
        </div>
        <div className="absolute font-['Bebas_Neue',sans-serif] text-[32vw] text-[rgba(201,168,76,0.03)] right-[-4vw] top-1/2 -translate-y-1/2 leading-none pointer-events-none select-none tracking-[-0.02em]">
          05
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-7">
            ...
            <span className="text-[0.7rem] tracking-[0.22em] uppercase text-[#c9a84c]">Our Process</span>
          </div>
          <h1 className="font-['Cormorant_Garamond',serif] text-[clamp(3.8rem,7.5vw,7.5rem)] font-light leading-[0.9] tracking-[-0.025em] mb-9">
            Legal work<br />
            done <em className="italic text-[#c9a84c] not-italic">the right</em><br />
            way.
          </h1>
          ...
          <div className="flex flex-wrap gap-2.5">
            <div className="border border-[rgba(201,168,76,0.2)] text-[0.65rem] tracking-[0.14em] uppercase px-[18px] py-2 text-[rgba(245,240,232,0.5)] hover:border-[#c9a84c] hover:text-[#c9a84c] transition-all">Transparent Process</div>
            <div className="border border-[rgba(201,168,76,0.2)] text-[0.65rem] tracking-[0.14em] uppercase px-[18px] py-2 text-[rgba(245,240,232,0.5)] hover:border-[#c9a84c] hover:text-[#c9a84c] transition-all">Fixed Timelines</div>
            <div className="border border-[rgba(201,168,76,0.2)] text-[0.65rem] tracking-[0.14em] uppercase px-[18px] py-2 text-[rgba(245,240,232,0.5)] hover:border-[#c9a84c] hover:text-[#c9a84c] transition-all">Flat Fees</div>
            <div className="border border-[rgba(201,168,76,0.2)] text-[0.65rem] tracking-[0.14em] uppercase px-[18px] py-2 text-[rgba(245,240,232,0.5)] hover:border-[#c9a84c] hover:text-[#c9a84c] transition-all">Creative Industry Focus</div>
          </div>
        </div>

        <div className="relative z-10 hidden lg:flex flex-col items-end justify-end gap-0 pb-1">
          <div className="text-right py-7 border-t border-[rgba(201,168,76,0.2)] w-[200px] last:border-b">
            <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#c9a84c] leading-none mb-1.5">48h</div>
            <div className="text-[0.65rem] tracking-[0.14em] uppercase text-[#888]">Standard Contract Review</div>
          </div>
          <div className="text-right py-7 border-t border-[rgba(201,168,76,0.2)] w-[200px] last:border-b">
            <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#c9a84c] leading-none mb-1.5">30m</div>
            <div className="text-[0.65rem] tracking-[0.14em] uppercase text-[#888]">Free Discovery Call</div>
          </div>
          <div className="text-right py-7 border-t border-[rgba(201,168,76,0.2)] w-[200px] last:border-b">
            <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#c9a84c] leading-none mb-1.5">100%</div>
            <div className="text-[0.65rem] tracking-[0.14em] uppercase text-[#888]">Fee Transparency</div>
          </div>
          <div className="text-right py-7 border-t border-[rgba(201,168,76,0.2)] w-[200px] last:border-b">
            <div className="font-['Cormorant_Garamond',serif] text-5xl font-light text-[#c9a84c] leading-none mb-1.5">500+</div>
            <div className="text-[0.65rem] tracking-[0.14em] uppercase text-[#888]">Brands Protected</div>
          </div>
        </div>

        <div className="absolute left-8 lg:left-16 bottom-[90px] flex items-center gap-3.5 text-[0.65rem] tracking-[0.18em] uppercase text-[#888]">
          <div className="w-[60px] h-px bg-[#888] relative overflow-hidden">
            <div className="absolute top-0 left-[-100%] w-full h-full bg-[#c9a84c] animate-[scanLine_2.2s_ease-in-out_infinite]" />
          </div>
          See the Process
        </div>
      </section>
      ...
      {/* Timeline Section */}
      <section className="px-6 md:px-8 lg:px-16 py-24 lg:py-[140px] relative">
        <div className="mb-[100px] flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-11 h-px bg-[#c9a84c]" />
              <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#c9a84c]">Phase by Phase</span>
            </div>
            <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2.2rem,4.5vw,4rem)] font-light leading-[1.05]">
              Five phases.<br /><em className="italic text-[#c9a84c] not-italic">One seamless journey.</em>
            </h2>
          </div>
        ...
        <div className="relative lg:before:absolute lg:before:left-1/2 lg:before:top-0 lg:before:bottom-0 lg:before:w-px lg:before:bg-[rgba(201,168,76,0.2)] lg:before:transform lg:before:-translate-x-1/2">
          {phases.map((phase, idx) => (
            <div key={idx} className="grid lg:grid-cols-[1fr_80px_1fr] gap-0 relative mb-0">
              ...
              <div className={`lg:col-start-${idx % 2 === 0 ? '1' : '3'} lg:row-start-1 lg:py-[60px] lg:px-0 py-10 px-0 ${idx % 2 === 0 ? 'lg:pr-16 lg:text-left text-left' : 'lg:pl-16 lg:text-left text-left'} border-b border-[rgba(245,240,232,0.07)]`}>
                <div className={idx % 2 === 0 ? '' : 'lg:order-2'}>
                  <div className="flex items-center gap-2.5 mb-3.5">
                    ...
                    <span className="text-[0.6rem] tracking-[0.2em] uppercase text-[#c9a84c]">Phase {phase.num}</span>
                  </div>
                  <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(1.8rem,3vw,2.8rem)] font-light leading-[1.1] mb-4">
                    {phase.title}<br /><em className="italic text-[#c9a84c] not-italic">{phase.subtitle}</em>
                  </h2>
                  ...
                  <ul className="list-none space-y-2.5 mb-7">
                    {phase.checklist.map((item, i) => (
                      <li key={i} className="flex items-start gap-3 text-[0.82rem] text-[rgba(245,240,232,0.65)] leading-relaxed">
                        <span className="text-[#c9a84c] text-[0.6rem] mt-1 flex-shrink-0">✦</span>
                        {item}
                      </li>
                    ))}
                  </ul>
                  <div className="inline-flex items-center gap-2 border border-[rgba(201,168,76,0.2)] px-4 py-2 text-[0.68rem] tracking-[0.14em] uppercase text-[#c9a84c]">
                    {phase.timeBadge}
                  </div>
                </div>
              </div>
              ...
              <div className="hidden lg:flex lg:col-start-2 lg:row-start-1 flex-col items-center justify-start pt-16 relative">
                <div className="w-14 h-14 border border-[#c9a84c] flex items-center justify-center bg-black relative z-10 font-['Bebas_Neue',sans-serif] text-[1.3rem] text-[#c9a84c] transition-all duration-400 hover:bg-[#c9a84c] hover:text-black hover:shadow-[0_0_40px_rgba(201,168,76,0.3)]">
                  {phase.num}
                </div>
              </div>
              ...
              <div className={`hidden lg:block lg:col-start-${idx % 2 === 0 ? '3' : '1'} lg:row-start-1 lg:py-[60px] ${idx % 2 === 0 ? 'lg:pl-16' : 'lg:pr-16 lg:text-right'} border-b border-[rgba(245,240,232,0.07)]`}>
                <div className={`border border-[rgba(201,168,76,0.2)] p-8 relative overflow-hidden transition-all duration-400 hover:border-[rgba(201,168,76,0.5)] group ${idx % 2 !== 0 ? 'text-right' : ''}`}>
                  ...
                  <div className="text-[0.62rem] tracking-[0.18em] uppercase text-[#c9a84c] mb-4">{idx % 2 === 0 ? 'What our clients say' : 'What\'s included'}</div>
      ...
      {/* Promise Strip */}
      <div className="bg-[#c9a84c] overflow-hidden">
      ...
      {/* Retainer Section */}
      <section className="px-6 md:px-8 lg:px-16 py-24 lg:py-[140px] bg-[rgba(255,255,255,0.015)]">
        <div className="mb-20">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-11 h-px bg-[#c9a84c]" />
            <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#c9a84c]">Ongoing Protection</span>
          </div>
          <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2rem,4.5vw,3.8rem)] font-light leading-[1.1] mt-3">
            Three ways to work<br /><em className="italic text-[#c9a84c] not-italic">with us long-term.</em>
          </h2>
        </div>

        <div className="grid lg:grid-cols-3 gap-px bg-[rgba(201,168,76,0.2)]">
          {retainerPlans.map((plan, idx) => (
            <div key={idx} className={`bg-black p-10 lg:p-[48px_36px] relative overflow-hidden transition-all duration-350 hover:-translate-y-1.5 ${plan.featured ? 'bg-[rgba(201,168,76,0.06)]' : ''}`}>
              <div className={`text-[0.6rem] tracking-[0.18em] uppercase inline-block px-3.5 py-1.5 mb-7 ${plan.featured ? 'bg-[#c9a84c] text-black border-[#c9a84c]' : 'border border-[rgba(201,168,76,0.2)] text-[#c9a84c]'}`}>
                {plan.badge}
              </div>
              <h3 className="font-['Cormorant_Garamond',serif] text-[1.8rem] font-normal mb-2 text-[#f5f0e8]">{plan.title}</h3>
              <div className="text-[0.8rem] text-[#c9a84c] italic mb-6">{plan.tagline}</div>
              ...
              <button onClick={openModal} className={`border text-[0.72rem] tracking-[0.14em] uppercase px-7 py-3 transition-all duration-300 ${plan.featured ? 'bg-[#c9a84c] text-black border-[#c9a84c] hover:bg-[#e8d5a3]' : 'border-[rgba(201,168,76,0.2)] text-[#f5f0e8] hover:border-[#c9a84c] hover:text-[#c9a84c]'}`}>
      ...
      {/* FAQ Section */}
      <section className="px-6 md:px-8 lg:px-16 py-24 lg:py-[120px]">
        <div className="mb-[70px]">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-11 h-px bg-[#c9a84c]" />
            <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#c9a84c]">Common Questions</span>
          </div>
          <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2rem,4vw,3.5rem)] font-light leading-[1.1] mt-3">
            Things people ask us<br /><em className="italic text-[#c9a84c] not-italic">before they start.</em>
          </h2>
        </div>
          ...
          {faqs.map((faq, idx) => (
            <div key={idx} className="border-b border-[rgba(245,240,232,0.07)] py-7 cursor-pointer" onClick={() => toggleFaq(idx)}>
              <div className="flex justify-between items-start gap-5">
                ...
                <span className={`text-[#c9a84c] text-lg flex-shrink-0 transition-transform duration-300 ${openFaq === idx ? 'rotate-45' : ''}`}>+</span>
              </div>
      ...
      {/* Final CTA */}
      <section className="text-center px-6 md:px-8 lg:px-16 py-28 lg:py-[160px] relative overflow-hidden">
        <div className="absolute font-['Bebas_Neue',sans-serif] text-[30vw] text-[rgba(201,168,76,0.025)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap pointer-events-none tracking-[0.05em]">
          START
        </div>
        <div className="relative z-10">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="w-11 h-px bg-[#c9a84c]" />
            <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#c9a84c]">Ready to Start</span>
          </div>
          <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(2.5rem,6vw,5.5rem)] font-light leading-[1.05] mb-6">
            Your first step costs<br />you <em className="italic text-[#c9a84c] not-italic">nothing.</em>
          </h2>
          ...
          <div>
            <button onClick={openModal} className="bg-[#c9a84c] text-black px-11 py-4 text-[0.76rem] tracking-[0.16em] uppercase font-medium border-none transition-all hover:bg-[#e8d5a3] hover:-translate-y-1 cursor-pointer">
      ...
      <div id="modalOverlay" className="fixed inset-0 z-[1000] bg-[rgba(10,10,10,0.92)] flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-400" onClick={closeModalOutside}>
        <div className="bg-black border border-[rgba(201,168,76,0.2)] p-10 lg:p-14 max-w-[520px] w-[90%] relative transform translate-y-7 transition-transform duration-400">
          ...
          <div className="flex items-center gap-3 mb-2.5">
            <div className="w-11 h-px bg-[#c9a84c]" />
            <span className="text-[0.68rem] tracking-[0.22em] uppercase text-[#c9a84c]">Free Consultation</span>
          </div>
          <h3 className="font-['Cormorant_Garamond',serif] text-3xl mb-1.5">Let's talk about<br /><em className="italic text-[#c9a84c] not-italic">your brand.</em></h3>
          ...
          <div className="mb-4">
            <label className="block text-[0.65rem] tracking-[0.16em] uppercase text-[#c9a84c] mb-1.5">Your Name</label>
            <input type="text" placeholder="Priya Sharma" className="w-full bg-transparent border border-[rgba(201,168,76,0.2)] text-[#f5f0e8] font-['DM_Sans',sans-serif] text-[0.88rem] p-3 outline-none focus:border-[#c9a84c] transition-colors" />
          </div>
          <div className="mb-4">
            <label className="block text-[0.65rem] tracking-[0.16em] uppercase text-[#c9a84c] mb-1.5">Email</label>
            <input type="email" placeholder="priya@yourbrand.com" className="w-full bg-transparent border border-[rgba(201,168,76,0.2)] text-[#f5f0e8] font-['DM_Sans',sans-serif] text-[0.88rem] p-3 outline-none focus:border-[#c9a84c] transition-colors" />
          </div>
          <div className="mb-4">
            <label className="block text-[0.65rem] tracking-[0.16em] uppercase text-[#c9a84c] mb-1.5">I am a...</label>
            <select className="w-full bg-transparent border border-[rgba(201,168,76,0.2)] text-[#f5f0e8] font-['DM_Sans',sans-serif] text-[0.88rem] p-3 outline-none focus:border-[#c9a84c] transition-colors">
          ...
          <div className="mb-6">
            <label className="block text-[0.65rem] tracking-[0.16em] uppercase text-[#c9a84c] mb-1.5">What do you need help with?</label>
            <textarea placeholder="Tell us briefly..." className="w-full bg-transparent border border-[rgba(201,168,76,0.2)] text-[#f5f0e8] font-['DM_Sans',sans-serif] text-[0.88rem] p-3 outline-none focus:border-[#c9a84c] transition-colors h-[90px] resize-vertical"></textarea>
          </div>
          <button onClick={() => { alert("Thank you! We'll confirm your consultation within 24 hours."); closeModal(); }} className="w-full bg-[#c9a84c] text-black py-4 text-[0.76rem] tracking-[0.16em] uppercase font-medium border-none transition-all hover:bg-[#e8d5a3] cursor-pointer">
            Book My Free Call →
          </button>
        </div>
      </div>
